...
Eleven design docs went up a version, listed in the plan's stage line.
...
reference and `patterns-029.md`. Both were rewritten around the real  
...
- [matryoshka-api-reference-042.md](matryoshka-api-reference-042.md) — the API surface, rewritten to real pointers across 12-2 through 12-4.
