...
- [rules-046.md](rules-046.md) — coding, doc, and process rules.
...
- See [matryoshka-api-reference-040.md](matryoshka-api-reference-040.md),
...
- See [rules-046.md](rules-046.md) for how to phrase this in `src/` comments.
...
[rules-046.md](rules-046.md), "Story structure".
