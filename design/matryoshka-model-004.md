# Matryoshka Thinking Model (004)

Versioned doc. Replaces [matryoshka-model-003.md](matryoshka-model-003.md).

Change from -003: banned-word pass. `ownership` removed throughout — the mantra  
still asks who holds the item, and "exclusive access" is now the term for what  
the holder has. Replacement table in rules-032.md. Two dead companion links fixed:  
rules-003.md and patterns-002.md have not existed for many versions.

The mental model behind every Matryoshka design decision.  
Companion: [rules-032.md](rules-032.md) — the coding and process rules.  
...
- See "When to allocate a Master" above and the Master pattern rule in [rules-032.md](rules-032.md).
- Part of the docs.
...
- Code is structured around Masters. See [patterns-020.md](patterns-020.md) for the coding patterns and the Master composition pattern.
