# Matryoshka Zig — Rules (036)

Versioned doc. Replaces [rules-035.md](rules-035.md).  
...
The pattern catalog lives in [patterns-024.md](patterns-024.md).
...
Catalog: [patterns-024.md](patterns-024.md), "The last branch of a dispatch  
chain".
