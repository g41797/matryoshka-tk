# Matryoshka Thinking Model (007)

Versioned doc. Replaces [matryoshka-model-006.md](matryoshka-model-006.md).
...
DISPATCH 1 (2026-07-31): companion links point at rules-036.md and patterns-024.md.  
...
Companion: [rules-036.md](rules-036.md) — the coding and process rules.  
Companion: [patterns-024.md](patterns-024.md) — reusable coding patterns.
...
- See [rules-036.md](rules-036.md) for how to phrase this in `src/` comments.
...
- See "When to allocate a Master" above and the Master pattern rule in [rules-036.md](rules-036.md).
- Part of the docs.
...
- Code is structured around Masters. See [patterns-024.md](patterns-024.md) for the coding patterns and the Master composition pattern.
