# 3tk — staging plan 027

Written 2026-09-07.

**Provenance.** Follows [3tk-staging-plan-026.md](backup/3tk-staging-plan-026.md).
**026 ran three stages** — 3TK-62, 3TK-63 and 3TK-64 — and its remaining two are
carried here unchanged in substance. **What 027 adds is one stage that 026 did
not foresee: `3TK-pre-65`**, ruled by the owner on 2026-09-07 after reading
`helper.c3` and `inner.c3` and finding both unreadable.
...
**And one correction 027 adds, from the INTR:** `struct OuterHelper {}` is not a
...
### And the docs site is the third thing wrong, found after the plan was written

**Owner, 2026-09-07, having read the generated site: *"mtk is non-readable, lot
...
**This plan.** `026` moves to `design/secondary/lang/c3/backup/` with a plain
`mv`, joining 019–025.
