...
**This is 002, written by 3TK-43.** It carries all of `001`, and adds the
register, the measured facts about both renderers, and the rules for moving a
module description. `001` is in `backup/`.
