# Matryoshka Zig — Rules (030)

Versioned doc. Replaces [rules-029.md](rules-029.md).  
...
Companion: [patterns-019.md](patterns-019.md) — reusable coding patterns.
...
- `ItemList._list` is the escape hatch. While a caller uses it, the `ItemList` promises are suspended. Tests that manipulate raw links use it; application code does not.
...
The pattern catalog lives in [patterns-019.md](patterns-019.md).
