...
Companion: [matryoshka-api-reference-037.md](matryoshka-api-reference-037.md) — the shipped surface.\  
...
Hold is the common foundation of all higher-level behavior.
