# Matryoshka Zig — Pattern and Idiom Catalog (020)

Versioned doc. Replaces [patterns-019.md](patterns-019.md).
...
replacement table is in rules-032.md. `escape hatch` also removed — banned in  
rules-032. Companion cross-references updated to rules-032.md and  
...
Companion: [rules-032.md](rules-032.md) — what is mandatory.  
