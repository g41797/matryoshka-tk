...
# "Where a doc lives" rule in rules-047.md and its links are not repaired.
...
while IFS= read -r f; do
    ...
    # NNN / 0NN are filename templates in rules-047.md, not references.
...
#   - "Status file ownership" — the name of a rule in rules-047.md.
...
# rules-047.md and language-of-matryoshka.md carry the banned-word table
